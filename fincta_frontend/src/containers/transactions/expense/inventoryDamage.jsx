  ...
  return (
    <>
      <CustomModal
        ...
        counterTitle="Damaged Inventory Quantity"
        inputTitle="Damaged Inventory Amount"
        pay
        accountClass={transaction.expense.accountClass}
        subAccount={transaction.expense.subAccount.inventoryDamage}
        close={props.close}
...
export default InventoryDamage;
